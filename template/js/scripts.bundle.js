      ...
      if (0 !== e(this).length && !e(this).hasClass("m-datatable--loaded")) {
        ...
        var n = {
          ...
          fullRender: function () {
            if (
              (n.spinnerCallback(!0),
              e(a).removeClass("m-datatable--loaded"),
              n.isLocked())
            ) {
              var t = e(a.oriTable).children();
              t.length > 0 &&
                (e(a).removeClass("m-datatable--lock"),
            ...
            i.table === e(a.table).attr("id") &&
              ...
              e(a).ready(function () {
                e(a.tableBody)
                  ...
                  e(a).addClass("m-datatable--loaded"),
                  n.scrollbar.call(),
                  n.spinnerCallback(!1);
              }));
          },
          ...
          initHeight: function () {
            if (t.layout.height && t.layout.scroll) {
              ...
              void 0 !== n && (i -= n),
                void 0 !== o && (i -= o),
                e(a.tableBody).height(i);
            }
          },
          setupBaseDOM: function () {
            (a.old = e(a).clone()),
              t.layout.height && e(a).height(t.layout.height),
              ...
              t.layout.height && e(a.table).height(t.layout.height),
              null === t.data.type &&
                    ...
                    .each(function (t, a) {
                      ...
                      if (void 0 !== o && void 0 !== o.template) {
                        ...
                        "string" == typeof o.template &&
                          (r = n.dataPlaceholder(o.template, l)),
            ...
            if (0 !== a.jsonData.length) {
              ...
              var i = function (t) {
                ...
                if (
                  ...
                  if (e(t).find('.m-checkbox [type="checkbox"]').length > 0)
                    return;
          ...
          dataRender: function () {
            ...
            var o = function (o) {
              e(a).removeClass("m-datatable--error"),
                t.pagination &&
                  (void 0 !== o &&
                  t.data.serverPaging &&
                  "local" !== t.data.type
                    ? n.paging(o.meta)
                    : n.paging(null, function (t, o) {
                        e(t.pager)
                          .off()
                          .on(
          ...
          getData: function () {
            ...
            return (
              ...
              "remote" === t.data.type &&
                ...
                (i.data.datatable = e.extend(
                  {},
                  o.getDataSourceParam(),
          ...
          paging: function (i, l) {
            var r = {
              ...
              init: function (i) {
                (r.meta = i),
                  (void 0 !== i && null !== i) ||
                    ((r.meta = o.getDataSourceParam("pagination")),
                    0 === r.meta.perpage &&
                      (r.meta.perpage = t.data.pageSize || 10),
                    (r.meta.total = a.jsonData.length),
                    (r.initCallback = !0)),
                  (r.meta.pages = Math.max(
                    Math.ceil(r.meta.total / r.meta.perpage),
                    1
                  )),
                  r.meta.page > r.meta.pages && (r.meta.page = r.meta.pages),
                  (r.paginateEvent = n.getTablePrefix()),
                  (r.pager = e(a.table).siblings(".m-datatable__pager")),
                  e(r.pager).hasClass("m-datatable--paging-loaded") ||
                    (e(r.pager).remove(),
                    0 !== r.meta.pages &&
                      (o.setDataSourceParam("pagination", r.meta),
                      (r.callback = r.serverCallback),
                      "function" == typeof l && (r.callback = l),
                      r.addPaginateEvent(),
                      r.populate(),
                      (r.meta.page = Math.max(r.meta.page || 1, r.meta.page)),
                      e(a).trigger(r.paginateEvent, r.meta),
                      r.initCallback && r.callback(r, r.meta),
                      r.pagingBreakpoint.call(),
                      e(window).resize(r.pagingBreakpoint)));
              },
              ...
              populate: function () {
                  ...
                  e("<li/>")
                    .append(
                      e("<a/>")
                        ...
                        .on("click", r.gotoMorePage)
                        .attr("data-page", r.meta.pages)
                    )
                    .appendTo(i),
                  o.getOption("toolbar.items.info") &&
                    (r.pagerLayout.info = e("<div/>")
                ...
                var d = e("<select/>")
                  ...
                  .val(r.meta.perpage)
                  .on("change", r.updatePerpage)
                  .prependTo(r.pagerLayout.info);
                e.each(
                  o.getOption("toolbar.items.pagination.pageSizeSelect"),
                  function (t, a) {
                    var n = a;
                    -1 === a && (n = "All"),
                      e("<option/>").attr("value", a).html(n).appendTo(d);
                  }
                ),
                  e(a).ready(function () {
                    e(".selectpicker")
              ...
              paste: function () {
                e.each(
                  ...
                  function (t, n) {
                    "bottom" === n && e(r.pager).clone(!0).insertAfter(a.table),
                      "top" === n &&
                        e(r.pager)
                          .clone(!0)
              ...
              gotoMorePage: function (t) {
                ...
                return (
                  ...
                  e(r.pager)
                    .find(
                      '.m-datatable__pager-link-number[data-page="' + a + '"]'
                    )
                    .trigger("click"),
                  !1
                );
              ...
              gotoPage: function (t) {
                t.preventDefault(),
                  e(this).hasClass("m-datatable__pager-link--active") ||
                    ((r.meta.page = parseInt(e(this).data("page"))),
                    e(a).trigger(r.paginateEvent, r.meta),
                    r.callback(r, r.meta),
                    e(r.pager).trigger("m-datatable--on-goto-page", r.meta));
              },
              updatePerpage: function (t) {
                t.preventDefault(),
                  ...
                  (r.pager = e(a.table)
                    .siblings(".m-datatable__pager")
                    .removeClass("m-datatable--paging-loaded")),
                  t.originalEvent && (r.meta.perpage = parseInt(e(this).val())),
                  e(r.pager)
                    .find("select.m-datatable__pager-size")
                    .val(r.meta.perpage)
                    .attr("data-selected", r.meta.perpage),
                  o.setDataSourceParam("pagination", r.meta),
              ...
              addPaginateEvent: function (t) {
                e(a)
                  .off(r.paginateEvent)
                  .on(r.paginateEvent, function (t, i) {
                    n.spinnerCallback(!0),
                      (r.pager = e(a.table).siblings(".m-datatable__pager"));
                      ...
                      function (a, l) {
                        if (mUtil.isInResponsiveRange(a)) {
                          switch (a) {
                            ...
                            case "tablet":
                              var s =
                                  Math.ceil(n / l.pagesNumber) * l.pagesNumber,
                                d = s - l.pagesNumber;
                              e(i).hide(),
              ...
              paginationUpdate: function () {
                ...
                e(i).each(function (t, a) {
                  ...
                  p === r.meta.pages && p === e(u).last().data("page")
                    ? e(i).parent().hide()
                    : e(i).parent().show(),
                  1 === r.meta.page
                    ? (e(l)
          ...
          setupSubDatatable: function () {
            ...
            if ("function" == typeof i) {
              ...
              e(a).addClass("m-datatable--subtable"),
              ...
              var l = function (n) {
                  ...
                  e(r).is(":hidden")
                    ...
                    : (e(d).addClass(
                      ...
                      (n.data = e.grep(a.jsonData, function (e, a) {
          ...
          stateKeep: function (e, a) {
            (e = n.getTablePrefix(e)),
              !1 !== t.data.saveState &&
                (t.data.saveState.webstorage && localStorage
              ...
              sortClick: function (l) {
                ...
                if (
                  ...
                  r.field === s && (d = r.sort),
                    ...
                    i.setIcon(),
                    !1 === t.data.serverSorting && n.updateRawData(),
                    setTimeout(function () {
          ...
          updateRawData: function () {
            ...
            return (
              "undefined" === e.type(a.fullJsonData) &&
                (a.fullJsonData = a.jsonData),
              (a.jsonData = e(a.fullJsonData).sort(function (e, a) {
                return "asc" === t.sort.sort
                  ? e[t.sort.field] > a[t.sort.field]
                    ? 1
                    : e[t.sort.field] < a[t.sort.field]
                    ? -1
                    : 0
              ...
              "string" === e.type(t.query.generalSearch) &&
                ((a.jsonData = e.grep(a.jsonData, function (a) {
                  for (var n in a)
                    if (
                      a.hasOwnProperty(n) &&
                      "string" === e.type(a[n]) &&
                      a[n].toLowerCase().indexOf(t.query.generalSearch) > -1
                    )
                      return !0;
                  return !1;
                })),
                delete t.query.generalSearch),
              "object" === e.type(t.query) &&
          ...
          filterArray: function (t, a, n) {
            if (
              ("undefined" === e.type(n) && (n = "AND"), "object" !== e.type(a))
            )
              return t;
            if (
        ...
        var o = {
          ...
          reload: function () {
            return (
              !1 === t.data.serverFiltering && n.updateRawData(),
              n.dataRender(),
          ...
          setActiveAll: function (t) {
            t
              ? o.setActive(e(a.table).find(".m-datatable__cell"))
              : o.setInactive(e(a.table).find(".m-datatable__cell")),
              e(a.table)
                .find('.m-checkbox [type="checkbox"]')
                .prop("checked", t || !1);
          },
        ...
        o = {
          ...
          build: function () {
            "accordion" === o.getSubmenuMode() &&
              ...
              ("dropdown" === o.getSubmenuMode() ||
                ...
                n.on("click", ".m-menu__link", o.handleSubmenuDropdownClose));
          },
          reset: function () {
          ...
          handleSubmenuDropdownClose: function (t) {
            if ("accordion" !== o.getSubmenuMode()) {
              ...
              a.length > 0 &&
                !1 === e(this).hasClass("m-menu__toggle") &&
                0 === e(this).find(".m-menu__toggle").length &&
                a.each(function () {
